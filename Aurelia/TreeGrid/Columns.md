---
layout: post
title: Column in Aurelia TreeGrid Control | Syncfusion
description: Learn here all about column support in Syncfusion Essential Aurelia TreeGrid control, its elements, and more.
platform: Aurelia
control: TreeGrid
documentation: ug
---

# Columns in Essential Aurelia TreeGrid
...
![Aurelia TreeGrid width](Columns_images/Column-Images_width.png)
...
![Aurelia TreeGrid column width(Columns_images/Column-Images_commonwidth.png)
...
![Aurelia TreeGrid proceding](Columns_images/Column-Images_preceding.png)
...
![Aurelia TreeGrid column menu](Columns_images/Column-Images_columnmenu.png)
